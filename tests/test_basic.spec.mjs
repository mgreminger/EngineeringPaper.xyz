...
test('Test basic functionality', async () => {
  ...
  await page.type(':nth-match(math-field, 1)', 'x=3[inch]');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'y=4[inch]');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'length=sqrt(x^2');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.type(':nth-match(math-field, 3)', '+y^2');
  // test using enter key for adding math cell
  await page.press(':nth-match(math-field, 3)', 'Enter');

  await page.type(':nth-match(math-field, 4)', 'length=[inch]');
  ...
  for(let i = 0; i<6; i++) {
    await page.press(':nth-match(math-field, 4)', 'Backspace');
  }
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.type(':nth-match(math-field, 1)', '1[mm] = [m]' );
  await page.type(':nth-match(math-field, 2)', '2[mm] = [mm]' );
  await page.type(':nth-match(math-field, 3)', '3[mm] = [cm]' );
  await page.type(':nth-match(math-field, 4)', '4[mm] = [dm]' );
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-units-3');
  ...
  // test exponents
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '2[mm]^2');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '+2[mm]^(1+3)^1/2');
  for (let i = 0; i<3; i++) {
    await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  }
  await page.press(':nth-match(math-field, 1)', '=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', '2^2');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '+2^1+3^1/2');
  for (let i = 0; i<3; i++) {
    await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  }
  await page.press(':nth-match(math-field, 2)', '=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-1');
  expect(parseFloat(content)).toBeCloseTo(10.643994170967826, precision);

  await page.click("#add-math-cell");
  await page.type(':nth-match(math-field, 3)', '3^3^3');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.press(':nth-match(math-field, 3)', '=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-2');
  ...
  await page.click("#add-math-cell");
  await page.type(':nth-match(math-field, 1)', '36^1/2');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '/2');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '*(1+2)=');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '1[meter] + 2[sec]=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-units-0');
  expect(content).toBe('Dimension Error');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', '/0.010[m]*2[mm]');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '5[sec]');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '+/(1[inches]/25.4');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', ')*12[mm]');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '6[sec]');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.press(':nth-match(math-field, 2)', '=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-1');
  ...
  await page.type(':nth-match(math-field, 2)', '[mm^2');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '/sec');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.press(':nth-match(math-field, 2)', ']');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-1');
  ...
  await page.press(':nth-match(math-field, 2)', 'ArrowLeft');
  await page.press(':nth-match(math-field, 2)', 'ArrowLeft');
  for(let i=0; i<3; i++){
    await page.press(':nth-match(math-field, 2)', 'Backspace');
  }
  await page.type(':nth-match(math-field, 2)', 'gallon');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-units-1');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', 'x=1')
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'x=2');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', 'x=y')
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'y=z')
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'z=x')
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('div.bx--inline-loading__text');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', 'x=/-b+sqrt(b^2');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '-4*a*c');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '2*a');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'x=[m]');
  // output is tall so button may move if clicked before update is completed
  // this leads to occasional test failures
  await page.waitForSelector('text=Updating...', {state: 'detached'}); 
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'a=1');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 4)', 'b=-5[m]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 5)', 'c=6[m*m]');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-1');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', 'pi=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  expect(parseFloat(content)).toBeCloseTo(3.14159265358979323846264338328, 14);

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'e=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-1');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'E=10');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 4)', 'E=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-3');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 5)', 'e=20');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 6)', 'pi=30');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 7)', 'i=30');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '\\ln 20=');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '\\ln(e^2.1');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', '\\ln(5[inches])=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-units-1');
  expect(content).toBe('Dimension Error');
  ...
  // check base 10 log
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', '\\log(100)=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-2');
  expect(parseFloat(content)).toBeCloseTo(2, precision);
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 4)', '\\log_2');
  await page.press(':nth-match(math-field, 4)', 'ArrowRight');
  await page.type(':nth-match(math-field, 4)', '(8)=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-3');
  expect(parseFloat(content)).toBeCloseTo(3, precision);
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 5)', '\\log_2[inches]');
  await page.press(':nth-match(math-field, 5)', 'ArrowRight');
  await page.type(':nth-match(math-field, 5)', '(8)=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 6)', 'log(1000)=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '10e-1[m]+1.E+16*x-1e17[m]=[mm]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'x=1.0e1[m]')
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '1[m]/0');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '=[inch]');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-units-0');
  expect(content).toBe('Units Mismatch');
  ...
  // test abs
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '|-12[inches]|=[feet]');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '1[mm^-2');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight')
  await page.type(':nth-match(math-field, 1)', ']=[inch^-2');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight')
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '1[1/sec');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight')
  await page.type(':nth-match(math-field, 1)', ']=')
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-units-0');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', '1[1/sec');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', ']=[min^-1');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.press(':nth-match(math-field, 2)', ']');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-1');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '1[meter]/0[foot]');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.press(':nth-match(math-field, 1)', '=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', '.1+.2-.3=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-0');
  expect(content).toBe('0');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'x=.1[m]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'y=.2[m]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 4)', 'z=.3[m]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 5)', 'x+y-z=[m]');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  content = await page.textContent('#result-value-4');
  expect(content).toBe('0');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 6)', 's=.1[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 7)', 't=.2[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 8)', 'u=.3[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 9)', 's+t-u=[inch]');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 10)', 'xx=1[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 11)', 'yy=2[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 12)', 'zz=1e-200[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 13)', 'w-yy=[inch]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 14)', 'w=zz+2*xx');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', 'x=10[inches]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'y=2');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'x/y');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.type(':nth-match(math-field, 3)', '=[inches]');
  await page.type(':nth-match(math-field, 2)', '[m]');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 1)', 'Expr=');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'symbols=');
  ...
  await page.type(':nth-match(math-field,2)', 'x');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '=');
  await page.type(':nth-match(math-field, 1)', 'x=');
  ...
  await page.type(':nth-match(math-field, 3)', '/4');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.type(':nth-match(math-field, 3)', '=');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field,1)', 'pi');
  await page.press(':nth-match(math-field,1)', 'Shift+ArrowLeft');
  await page.press(':nth-match(math-field,1)', 'Shift+ArrowLeft');
  await page.click('button.tab:has-text("f(x)")');
...
test('Test greek characters as variables', async () => {
  ...
  await page.type(':nth-match(math-field, 1)', 'alpha+beta+gamma+delta+epsilon+zeta+eta+theta+iota+kappa+lambda+' +
  ...
  await page.type(':nth-match(math-field, 2)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button.keyboard:has-text("β")');
  await page.type(':nth-match(math-field, 3)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button.keyboard:has-text("γ")');
  await page.type(':nth-match(math-field, 4)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("δ")');
  await page.type(':nth-match(math-field, 5)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ϵ")');
  await page.type(':nth-match(math-field, 6)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ζ")');
  await page.type(':nth-match(math-field, 7)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("η")');
  await page.type(':nth-match(math-field, 8)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("θ")');
  await page.type(':nth-match(math-field, 9)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ι")');
  await page.type(':nth-match(math-field, 10)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("κ")');
  await page.type(':nth-match(math-field, 11)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("λ")');
  await page.type(':nth-match(math-field, 12)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("μ")');
  await page.type(':nth-match(math-field, 13)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ξ")');
  await page.type(':nth-match(math-field, 14)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ρ")');
  await page.type(':nth-match(math-field, 15)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("σ")');
  await page.type(':nth-match(math-field, 16)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("τ")');
  await page.type(':nth-match(math-field, 17)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("υ")');
  await page.type(':nth-match(math-field, 18)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ϕ")');
  await page.type(':nth-match(math-field, 19)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("χ")');
  await page.type(':nth-match(math-field, 20)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ψ")');
  await page.type(':nth-match(math-field, 21)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ω")');
  await page.type(':nth-match(math-field, 22)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button.keyboard:has-text("Γ​"), 2)');
  await page.type(':nth-match(math-field, 23)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Δ"), 2)');
  await page.type(':nth-match(math-field, 24)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Θ"), 2)');
  await page.type(':nth-match(math-field, 25)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Λ"), 2)');
  await page.type(':nth-match(math-field, 26)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Ξ"), 2)');
  await page.type(':nth-match(math-field, 27)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Π​"), 2)');
  await page.type(':nth-match(math-field, 28)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Σ"), 2)');
  await page.type(':nth-match(math-field, 29)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("ϒ")');
  await page.type(':nth-match(math-field, 30)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button:has-text("Φ")');
  await page.type(':nth-match(math-field, 31)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Ψ"), 2)');
  await page.type(':nth-match(math-field, 32)', '=1');

  await page.waitForSelector('text=Updating...', {state: 'detached'});
  await page.click("#add-math-cell");
  await page.click('button.tab:has-text("αβγ")');
  await page.click(':nth-match(button:has-text("Ω"), 2)');
  await page.type(':nth-match(math-field, 33)', '=1');
...
test('Test variable names with subscripts', async () => {
  ...
  await page.type(':nth-match(math-field, 1)', 'v_initial');
  await page.press(':nth-match(math-field, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field, 1)', '=10');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'real_root');
  await page.press(':nth-match(math-field, 2)', 'ArrowRight');
  await page.type(':nth-match(math-field, 2)', '=2');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 3)', 'b_1');
  await page.press(':nth-match(math-field, 3)', 'ArrowRight');
  await page.type(':nth-match(math-field, 3)', '=2');

  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 4)', 'real_root');
  await page.press(':nth-match(math-field, 4)', 'ArrowRight');
  await page.type(':nth-match(math-field, 4)', '*v_initial');
  await page.press(':nth-match(math-field, 4)', 'ArrowRight');
  await page.type(':nth-match(math-field, 4)', '*b_1');
  await page.press(':nth-match(math-field, 4)', 'ArrowRight');
  await page.type(':nth-match(math-field, 4)', '=');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 5)', '1a=');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 6)', 'a_1b');
  await page.press(':nth-match(math-field, 6)', 'ArrowRight');
  await page.type(':nth-match(math-field, 6)', '=');
  await page.click('#add-math-cell');
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button.keyboard:has-text("α​")');
  await page.click('button.keyboard:has-text("β")');
  ...
  await page.click('button.tab:has-text("αβγ")');
  await page.click('button.keyboard:has-text("α​")');
  await page.type(':nth-match(math-field, 8)', '_10');
  await page.press(':nth-match(math-field, 8)', 'ArrowRight');
  await page.type(':nth-match(math-field, 8)', '=');
  // next 2 should be valid as well (letter followed by number for name or subscript)
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 9)', 'a1=');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 10)', 'a_b1');
  await page.press(':nth-match(math-field, 10)', 'ArrowRight');
  await page.type(':nth-match(math-field, 10)', '=');
...
test('Make sure results are updating after adding a documentation cell', async () => {
  ...
  await page.type(':nth-match(math-field, 1)', 'x=3');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field, 2)', 'x=');
  await page.waitForSelector('text=Updating...', {state: 'detached'});
...
test('Test syntax error Show Error button', async ({ browserName }) => {
  ...
  for (let i = 0; i < 20; i++) {
    await page.locator('math-field').nth(i).press('Enter');
  }
...
test('Check parsing error handling impact on displayed results', async () => {
  ...
  await page.locator('#cell-2 >> math-field').type('a');
