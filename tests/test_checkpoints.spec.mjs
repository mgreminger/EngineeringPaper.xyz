...
test('Test autosave checkpoints', async ({ page, browserName }) => {
  ...
  await page.locator('text=Checkpoint 3').waitFor({timeout: 100});
  ...
  await page.locator('#new-sheet').click();
  await page.locator('text=Checkpoint 3').waitFor({state: 'detached', timeout: 100});

  await page.goBack();
  await page.locator('text=Checkpoint 3').waitFor({timeout: 500});
