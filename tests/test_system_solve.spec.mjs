...
test('Test equation solving', async () => {
  ...
  await page.locator('#system-expression-0-0 math-field._editable').type('(x-2[meters])*(x-4[meters])=0');
  await page.locator('#system-parameterlist-0 math-field._editable').type('x');

  await page.locator('#add-system-cell').click();
  await page.locator('#system-expression-1-0 math-field._editable').type('y-z=0');
  await page.locator('#system-expression-1-0 math-field._editable').press('Enter');
  await page.locator('#system-expression-1-1 math-field._editable').type('z=10[meters]');
  await page.locator('#system-parameterlist-1 math-field._editable').type('y,z');
  ...
  await page.locator('#add-system-cell').click();
  await page.locator('#system-expression-0-0 math-field._editable').type('8*g+7*o+3*l=3*o+6*g+6*l');
  await page.locator('#add-row-0').click();
  await page.locator('#system-expression-0-1 math-field._editable').type('g=2*l/3');
  await page.locator('#add-row-0').click();
  await page.locator('#system-expression-0-2 math-field._editable').type('12*o=3[kg]');
  await page.locator('#system-parameterlist-0 math-field._editable').type('l,g,o');
  ...
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field._editable, 1)', 'k=1[N/m');
  await page.press(':nth-match(math-field._editable, 1)', 'ArrowRight');
  await page.type(':nth-match(math-field._editable, 1)', ']');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field._editable, 2)', 'm=1[kg]');
  await page.click('#add-math-cell');
  await page.type(':nth-match(math-field._editable, 3)', 'x=10[mm]');
  await page.click('#add-system-cell');
  await page.setLatex(3, String.raw`\frac{1}{2}\cdot k\cdot x^2=\frac{1}{2}\cdot m\cdot v^2`, 0);
  await page.locator('#system-parameterlist-3 math-field._editable').type('v');
  await page.click('#add-math-cell');
...
test('test underdetermined system that has exact numerical solution', async () => {
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('v,h,g')
...
test('Test solving system of 3 equations', async () => {
  ...
  await page.locator('#system-expression-0-0 math-field._editable').type('x+y=3');
  await page.locator('#add-row-0').click();
  await page.locator('#system-expression-0-1 math-field._editable').type('y=z-4');
  await page.locator('#add-row-0').click();
  await page.locator('#system-expression-0-2 math-field._editable').type('z=x^2');
  await page.locator('#system-expression-0-2 math-field._editable').press('ArrowRight');
  await page.locator('#system-expression-0-2 math-field._editable').type('-3');

  await page.locator('#system-parameterlist-0 math-field._editable').type('x,y,z');
...
test("Test case where all solutions don't have results for the same variables", async () => {
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('m,v');
...
test('Test function notation with equation solving and combined function/assignment and expression as argument for function', async () => {
  ...
  await page.locator('#system-parameterlist-4 math-field._editable').type('v')
  await page.click('#add-math-cell');
...
test('Test restarting pyodide on a calculation that has caused sympy to hang', async () => {
  ...
  await page.type(':nth-match(math-field._editable, 1)', 'zap=');
...
test('Test solve with extra variables', async () => {
  ...
  await page.type(':nth-match(math-field._editable, 1)', 'a*x+b*x+c=0');
  await page.locator('#system-parameterlist-0 math-field._editable').type('x');
...
test('Test system solve database saving and retrieving', async ({ browserName }) => {
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('a,y');
...
test('Test replacement of placeholder funcs with symbolic and numeric solve', async () => {
  ...
  await page.locator('#system-parameterlist-2 math-field._editable').type('y~.1');
...
test('Test numerical equation solving with units', async () => {
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('x~1.5[m]');

  // System with two Equations
  await page.locator('#add-system-cell').click();
  await page.locator('#system-expression-1-0 math-field._editable').type('y-z=0[m]');
  await page.locator('#system-expression-1-0 math-field._editable').press('Enter');
  await page.locator('#system-expression-1-1 math-field._editable').type('z=10[meters]');
  await page.locator('#system-parameterlist-1 math-field._editable').type('y~2[m],z~9[m]');
  ...
  for (let i = 0; i<8; i++) {
    await page.locator('#system-parameterlist-0 math-field._editable').press('Backspace');
  }
  await page.locator('#system-parameterlist-0 math-field._editable').type('x~10[m]');
  ...
  await page.locator('#add-row-0').click();
  await page.locator('#system-expression-0-2 math-field._editable').type('12*o=3[kg]');
  await page.locator('#system-parameterlist-0 math-field._editable').type('l~1[kg],g~-1[lb],o~1[kg]');
...
test('Test numerical solve error messages', async () => {
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('10');
  ...
  await page.setLatex(0, String.raw`\left(x-3\right)\cdot \left(x-5\right)=0`, 0);
  await page.locator('#system-parameterlist-0 math-field._editable').type('[mm]');
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('x~3, y~5');
...
test('Test numerical solution variable rendering', async () => {
  ...
  await page.locator('#system-parameterlist-0 math-field._editable').type('N~1, theta~3');
...
test('Test handling currently selected solution greater than number of solutions', async () => {
  ...
  await page.locator('#system-parameterlist-1 math-field._editable').type('x')
