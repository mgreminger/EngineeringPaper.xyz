...
test('Test table types in math cells', async () => {
  ...
  await page.locator('math-field._editable').nth(0).type('3');
  await page.locator('#add-math-cell').click();
  await page.locator('math-field._editable').nth(1).type('1.0');
  ...
  await page.locator('#add-math-cell').click();
  await page.locator('math-field._editable').nth(2).type('[inches]');
  ...
  await page.locator('#add-math-cell').click();
  await page.locator('math-field._editable').nth(3).type('a');
  await page.locator('#add-math-cell').click();
  await page.locator('math-field._editable').nth(4).type('aa');
  await page.locator('#add-math-cell').click();
  await page.locator('math-field._editable').nth(5).type('a_b');
...
test('Test parameter name error messages', async ({ browserName }) => {
  ...
  await page.locator('#parameter-name-0-0 math-field._editable').click();
  for (let i=0; i<5; i++) {
  ...
  await page.locator('#parameter-name-0-0 math-field._editable').type('1');
  ...
  await page.locator('#parameter-name-0-0 math-field._editable').dblclick();
  await page.locator('#parameter-name-0-0 math-field._editable').type('a');

  await page.locator('#parameter-name-0-1 math-field._editable').dblclick();
  await page.locator('#parameter-name-0-1 math-field._editable').type('a=b');
  content = await page.locator('#parameter-name-0-1 span[slot="tooltipText"]').textContent();
  expect(content).toBe('A variable name is required in this field.');

  await page.locator('#parameter-name-0-1 math-field._editable').dblclick();
  await page.locator('#parameter-name-0-1 math-field._editable').type('b');

  await page.locator('#parameter-name-0-2 math-field._editable').dblclick();
  await page.locator('#parameter-name-0-2 math-field._editable').type('a=');
...
test('Test parameter units error messages', async ({ browserName }) => {
  ...
  await page.locator('#parameter-units-0-0 math-field._editable').type('1');
  ...
  await page.locator('#parameter-units-0-0 math-field._editable').type('[m]');

  await page.locator('#parameter-units-0-1 math-field._editable').dblclick();
  await page.locator('#parameter-units-0-1 math-field._editable').type('a=b');
  content = await page.locator('#parameter-units-0-1 span[slot="tooltipText"]').textContent();
  expect(content).toBe('This field may only contain units in square brackets or may be left blank to indicate no units.');

  await page.locator('#parameter-units-0-1 math-field._editable').dblclick();
  await page.locator('#parameter-units-0-1 math-field._editable').type('b');

  await page.locator('#parameter-units-0-2 math-field._editable').dblclick();
  await page.locator('#parameter-units-0-2 math-field._editable').type('a=');
...
test('Test table cell error messages', async ({ browserName }) => {
  ...
  await page.locator('#parameter-units-0-0 math-field._editable').type('[in]');
  await page.locator('#parameter-units-0-1 math-field._editable').type('[m]');

  await page.locator('#grid-cell-0-0-0 math-field._editable').type('a');
  await page.locator('#grid-cell-0-0-1 math-field._editable').type('b=c');
  await page.locator('#grid-cell-0-0-2 math-field._editable').type('c=');

  await page.locator('#grid-cell-0-1-0 math-field._editable').type('1[in]');
  await page.locator('#grid-cell-0-1-1 math-field._editable').type('2');
  await page.locator('#grid-cell-0-1-2 math-field._editable').type('[in]');
  ...
  await page.locator('#grid-cell-0-0-1 math-field._editable').dblclick();
  await page.locator('#grid-cell-0-0-1 math-field._editable').type(' ');
...
test('Test table cell functionality', async ({ browserName }) => {
  ...
  for (let i = 0; i<4; i++) {
    await page.locator('#parameter-name-2-0 math-field._editable').press('Backspace');
  }
  await page.locator('#parameter-name-2-0 math-field._editable').type('a_1');
  
  for (let i = 0; i<4; i++) {
    await page.locator('#parameter-name-2-1 math-field._editable').press('Backspace');
  }
  await page.locator('#parameter-name-2-1 math-field._editable').type('alpha');

  await page.locator('#parameter-units-2-0 math-field._editable').type('[mm]');

  await page.locator('#grid-cell-2-0-0 math-field._editable').type('1000');
  ...
  await page.locator('#grid-cell-2-1-0 math-field._editable').press('Enter');
  ...
  for (let i = 0; i<4; i++) {
    await page.locator('#parameter-name-2-2 math-field._editable').press('Backspace');
  }
  await page.locator('#parameter-name-2-2 math-field._editable').type('c');

  await page.locator('#add-col-2').click();
  for (let i = 0; i<4; i++) {
    await page.locator('#parameter-name-2-3 math-field._editable').press('Backspace');
  }
  await page.locator('#parameter-name-2-3 math-field._editable').type('d');

  await page.locator('#grid-cell-2-2-2 math-field._editable').type('z');
  await page.locator('#grid-cell-2-1-3 math-field._editable').type('3');
...
test('Test fix for crash when last column deleted', async () => {
  ...
  await page.locator('math-field._editable').nth(0).type('Var2=');

  await page.locator('#add-table-cell').click();

  await page.locator('#grid-cell-1-0-0 math-field._editable').type('1');
  await page.locator('#grid-cell-1-0-1 math-field._editable').type('2');
