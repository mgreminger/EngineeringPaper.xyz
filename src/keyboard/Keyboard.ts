    ...
    },
    {
      ...
      content: {
        ...
        buttons: [[
          ...
          new Blank('0.25fr'),
          new Button({ buttonText: '\\ln', command: '\\ln\\left([selection]\\right)', method: "write", positionLeft: 1 }),
          new Button({ buttonText: '\\log_{10}', command: '\\log\\left([selection]\\right)', method: "write", positionLeft: 1 }),
          new Button({ buttonText: '\\log_{b}', command: '\\log_{}\\left([selection]\\right)', method: "write", positionLeft: 1 }),
          new Blank('0.25fr'),
          new Blank(),
          new Button({ buttonText: '⌫', command: 'Backspace', method: 'keystroke' }),
        ],
        [
          new Button({ buttonText: '\\arcsin', command: '\\arcsin\\left([selection]\\right)', method: 'write', positionLeft: 1 }),
          new Button({ buttonText: '\\arccos', command: '\\arccos\\left([selection]\\right)', method: 'write', positionLeft: 1 }),
          new Button({ buttonText: '\\arctan', command: '\\arctan\\left([selection]\\right)', method: 'write', positionLeft: 1 }),
          new Blank('0.25fr'),
        ...
        [
          ...
          new Blank('0.25fr'),
          new Button({ buttonText: '\\mathrm{real}', command: '\\mathrm{real}\\left([selection]\\right)', method: "write", positionLeft: 1 }),
        ...
        [
          ...
          new Button({ buttonText: '\\cosh', command: '\\cosh\\left([selection]\\right)', method: 'write', positionLeft: 1 }),
          new Button({ buttonText: '\\tanh', command: '\\tanh\\left([selection]\\right)', method: 'write', positionLeft: 1 }),
          new Blank('0.25fr'),
          new Button({ buttonText: '\\mathrm{angle}', command: '\\mathrm{angle}\\left([selection]\\right)', method: "write", positionLeft: 1 }),
