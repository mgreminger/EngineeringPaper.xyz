...
export const keyboards: Keyboards = {
  ...
  keyboards: [
    ...
    {
      tabText: String.raw`\(\hat{n}\mathrm{\smallint\Sigma}\)`,
      content: {
        type: "Buttons",
        buttons: [[
          ...
          new Blank('0.1fr'),
          new Button({ buttonText: '\\bar{n}', content: '\\bar{#@}', command: "insert"}),
          new Button({ buttonText: 'n^{\\prime}', content: "#@^{\\prime}", command: "insert"}),
          new Blank('0.1fr'),
          new Blank(),
          new Blank(),
          new Blank(),
        ...
        [
          ...
          new Blank('0.1fr'),
          new Button({ buttonText: '\\vec{n}', content: '\\vec{#@}', command: "insert"}),
          new Button({ buttonText: 'n^{\\prime\\prime}', content: "#@^{\\prime\\prime}", command: "insert"}),
          new Blank('0.1fr'),
          new Blank(),
          new Blank(),
          new Blank(),
        ...
        [
          ...
          new Blank('0.1fr'),
          new Button({ buttonText: '\\hat{n}', content: '\\hat{#@}', command: "insert"}),
          new Button({ buttonText: 'n^{\\prime\\prime\\prime}', content: "#@^{\\prime\\prime\\prime}", command: "insert"}),
          new Blank('0.1fr'),
          new Blank(),
          new Blank(),
          new Blank(),
        ...
        [
          ...
          new Blank(),
          new Blank('0.1fr'),
          new Button({ buttonText: '\\dot{n}', content: '\\dot{#@}', command: "insert"}),
          new Button({ buttonText: '\\ddot{n}', content: '\\ddot{#@}', command: "insert"}),
          new Blank('0.1fr'),
          new Blank(),
          new Blank(),
          new Blank(),
